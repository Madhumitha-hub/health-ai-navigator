...
from app.routers import analytics, clinical, eda, health, health_score, models, predict, recommendations
...
app.include_router(health_score.router, tags=["health-score"])
